    ...
    <header className="sticky top-0 z-50 w-full">
      ...
      <div className="border-b border-slate-200/70 bg-[#fffdf8]/92 backdrop-blur-2xl">
        <div className="mx-auto flex max-w-7xl items-center gap-4 px-4 py-4 sm:px-5 lg:px-8">
          ...
          <div className="ml-auto hidden flex-1 lg:flex lg:max-w-[340px]">
            <label className="flex w-full items-center gap-3 rounded-full border border-slate-200 bg-white px-4 py-3 shadow-[0_10px_30px_rgba(148,163,184,0.08)] transition focus-within:border-slate-400">
          ...
          <div className="hidden items-center gap-3 lg:flex">
            <button
              type="button"
              onClick={onCartClick}
              className={`inline-flex h-12 w-12 items-center justify-center rounded-full border bg-white text-slate-700 shadow-[0_10px_30px_rgba(148,163,184,0.08)] transition hover:-translate-y-0.5 hover:text-slate-950 ${
                cartOpen ? 'border-slate-950' : 'border-slate-200'
              }`}
              aria-label="Carrinho"
            >
