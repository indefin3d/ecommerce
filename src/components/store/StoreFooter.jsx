    ...
    <footer className="border-t border-slate-200 bg-[#f7f4ee] px-4 py-16 sm:px-5 lg:px-8">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-12 border-t border-slate-200 pt-6 text-sm text-slate-500">
          <p>
            © {new Date().getFullYear()} Urban Store. Protótipo sendo desenvolvido pela{' '}
            <a
              href="https://gomaster.com.br"
              target="_blank"
              rel="noreferrer"
              className="font-semibold text-slate-800 underline decoration-slate-300 underline-offset-4 transition hover:decoration-slate-800"
            >
              GoMaster
            </a>
            .
